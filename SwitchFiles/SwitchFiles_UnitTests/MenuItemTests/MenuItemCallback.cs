...
using Company.FastSwitchFile;

namespace SwitchFiles_UnitTests.MenuItemTests
{
  [TestClass()]
  public class MenuItemTest
  {
    ...
    {
      // Create the package
      IVsPackage package = new FastSwitchFilePackage() as IVsPackage;
      ...
      CommandID menuCommandID = new CommandID(Company.FastSwitchFile.GuidList.guidSwitchFilesCmdSet, (int)Company.FastSwitchFile.PkgCmdIDList.cmdidSwitchFiles);
