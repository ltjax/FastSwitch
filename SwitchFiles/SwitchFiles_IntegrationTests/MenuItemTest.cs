...
namespace SwitchFiles_IntegrationTests
{
  [TestClass()]
  public class MenuItemTest
  {
    ...
    public void LaunchCommand()
    {
      ...
      {
        CommandID menuItemCmd = new CommandID(Company.FastSwitchFile.GuidList.guidSwitchFilesCmdSet, (int)Company.FastSwitchFile.PkgCmdIDList.cmdidSwitchFiles);

        // Create the DialogBoxListener Thread.
        string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "SwitchFiles", "Company.SwitchFiles.SwitchFilesPackage");
